...
import com.example.foodapp.All.Fragment.BottomSheet;
...
public class FoodDiaryMealAdapter extends RecyclerView.Adapter<FoodDiaryMealAdapter.ViewHolder>{
    ...
    public FoodDiaryMealAdapter(Context context, ArrayList<MealPlanMealUpsertDto> model){
...
//    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        ArrayList<MealPlanMealIngredientUpsertDto> subAdapters = foodDiaryMealModel.getMealPlanMealIngredientUpsertDto();

        Log.d("HHHHHHHH", String.valueOf(subAdapters.size()));

        FoodDiaryMealSubAdapter foodDiaryMealAdapter = new FoodDiaryMealSubAdapter(context,subAdapters);

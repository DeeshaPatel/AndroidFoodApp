...
public class QuestionAdapter extends RecyclerView.Adapter<QuestionAdapter.MyViewHolder>{
    ...
    public QuestionAdapter(QuestionHolder[] questionHolders){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_view_for_questionaire,parent,false);
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        if (last == position)
        {
            holder.cardView.setCardBackgroundColor(Color.parseColor("#FFC9EDE7"));
        ...
        else
        {
            ...
            Typeface typeface = ResourcesCompat.getFont(holder.cardView.getContext(), R.font.opensansbold);
            holder.data.setTypeface(typeface);
            holder.data.setTextColor(Color.parseColor("#FF616161"));
